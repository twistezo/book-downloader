...
public class SceneController {
    ...
    private void setTextFieldsWithProperties() {
        ...
        downloadPath.setText(properties.getProperty(PropertiesManager.DOWNLOAD_PATH));
    }
    ...
    private void updatePropertiesFromUserInput() {
        ...
        try {
            ...
            properties.setProperty(PropertiesManager.DOWNLOAD_PATH, downloadPath.getText());
